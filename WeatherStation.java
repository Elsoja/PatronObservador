/**
 * WeatherStation - Clase Principal (Main / Simulador)
 *
 ...
 *
 * NOTA: Las temperaturas usadas son en grados Fahrenheit (°F),
 * ya que la fórmula del Heat Index requiere ese sistema de unidades.
 */
public class WeatherStation {
    ...
    public static void main(String[] args) {
        ...
        // 3. Simular cambios de mediciones (temperatura en °F, humedad en %, presión en inHg)
